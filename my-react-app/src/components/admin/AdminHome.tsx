...
const AdminDashboard: React.FC = () => {
  ...
  // Bar chart data for user activity
  const userData = [
  ...
  return (
    <div className="admin-dashboard flex h-screen">
      <nav className="bg-gray-800 text-white p-6 hidden md:block">
        <ul>
          <li className={`mb-4 cursor-pointer ${activeSection === 'dashboard' ? 'font-bold' : ''}`} onClick={() => handleSectionChange('dashboard')}>
            Dashboard
          </li>
          <li className={`mb-4 cursor-pointer ${activeSection === 'problems' ? 'font-bold' : ''}`} onClick={() => handleSectionChange('problems')}>
            Problems
          </li>
          

          <li className={`mb-4 cursor-pointer ${activeSection === 'users' ? 'font-bold' : ''}`} onClick={() => handleSectionChange('users')}>
            Users
          </li>
          <li className={`mb-4 cursor-pointer ${activeSection === 'leaderboard' ? 'font-bold' : ''}`} onClick={() => handleSectionChange('leaderboard')}>
            Leaderboard
          </li>
          <li className={`mb-4 cursor-pointer ${activeSection === 'subscription' ? 'font-bold' : ''}`} onClick={() => handleSectionChange('subscription')}>
            Subscription
          </li>
        </ul>
      </nav>
